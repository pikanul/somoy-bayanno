...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'disks' => [
                env('BACKUP_LOCAL_DISK', 'backup_local'),
            ],
         ...
         */
        'encryption' => env('BACKUP_ARCHIVE_ENCRYPTION', 'none'),
    ...
    'monitor_backups' => [
        [
            'name' => env('APP_NAME', 'laravel-backup'),
            'disks' => [env('BACKUP_LOCAL_DISK', 'backup_local')],
            'health_checks' => [
                MaximumAgeInDays::class => (int) env('BACKUP_MAX_AGE_DAYS', 7),
